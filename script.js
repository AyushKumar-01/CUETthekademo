...
// Function to increment the answered question count and update the counter
...
function checkAnswer() {
    ...
    if (selectedOption) {
      ...
      // Call the function to increment the answered question count and update the counter
      updateCounter();
  ...
  function displayResult() {
    ...
    resultContainer.style.textDecorationColor = "green";
  }
  ...
  function showAnswer() {
    ...
    for (let i = 0; i < incorrectAnswers.length; i++) {
      incorrectAnswersHtml += `
        <p>
          <strong></strong> ${incorrectAnswers[i].question}<br>
